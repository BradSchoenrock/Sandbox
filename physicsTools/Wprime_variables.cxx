#include "TopD3PDSelection/Wprime_variables.h"
#include "TopD3PDSelection/KinematicUtils.h"
#include "TLorentzVector.h"
#include <cmath>

namespace Wprime_variables {
...
//-------------------------------------------------------------------------------
  ...
  TLorentzVector Wneutrino(double MET, double METphi, double leptonPT, double leptonEta, double leptonPhi) {
    ...
    TLorentzVector neutrino.SetPxPyPzE(neutrinoPX,neutrinoPY,neutrinoPZ,std::sqrt(std::pow(neutrinoPX,2)+std::pow(neutrinoPY,2)+std::pow(neutrinoPZ,2)));
    return  neutrino;
  }
